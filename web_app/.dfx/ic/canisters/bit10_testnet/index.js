...
import { idlFactory } from './bit10_testnet.did.js';
export { idlFactory } from './bit10_testnet.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BIT10_TESTNET;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bit10_testnet.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bit10_testnet canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bit10_testnet.did.js")._SERVICE>}
 */
export const bit10_testnet = createActor(canisterId);

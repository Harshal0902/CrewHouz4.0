...
export default function NonRebalanceCollateral() {
    ...
    const bit10DEFITokens = bit10Queries[1].data as { id: number, name: string, symbol: string, price: number }[];
            ...
            {isLoading ? (
                ...
                <div className='w-full lg:col-span-1 animate-fade-left-slow'>
                    <div className='flex flex-col space-y-4 md:space-y-8'>
                        <div>
                            <div className='text-2xl'>Test BIT10.DEFI</div>
                            <div className='grid md:grid-cols-3 gap-4 items-center'>
                                ...
                                <div className='flex w-full flex-col space-y-3 col-span-2'>
                                    <h1 className='text-2xl'>Test BIT10.DEFI</h1>
                                    ...
                                    <h1 className='text-lg flex flex-row items-center'>Test BIT10.DEFI Price: {bit10DEFIPrice ? bit10DEFIPrice.toFixed(4) : <LoaderCircle className='animate-spin ml-1 h-5 w-5' />} USD</h1>
